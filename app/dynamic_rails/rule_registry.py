...
RULE_TEMPLATES: Dict[str, List[Dict[str, Any]]] = {
    'medical': [
        ...
        },
        {
            ...
            'domain': 'medical',
            'rule_type': 'block',
            'description': 'Блокировать пошаговые инструкции по выполнению хирургических операций для самолечения',
            'severity': 'critical',
            'condition': 'Пользователь просит пошаговую инструкцию для самостоятельного выполнения хирургической процедуры',
            'action': 'Заблокировать и перенаправить к врачу',
        },
        {
            'rule_id': 'med_dosage_warning',
            'domain': 'medical',
            'rule_type': 'warn',
            'description': 'Предупреждать что дозировки из клинических рекомендаций требуют верификации лечащим врачом',
            'severity': 'high',
            'condition': 'Ответ содержит конкретные дозировки препаратов',
            'action': 'Добавить предупреждение что дозировки носят справочный характер и должны быть согласованы с лечащим врачом',
        },
    ],
    'financial': [
        {
